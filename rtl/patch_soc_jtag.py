...
module mips_soc (
    ...
    axi_decoder_1x2 u_axi_decoder (
        ...
        .m_awid          (axim_f_awid),
        .m_awaddr        (axim_f_awaddr),
        .m_awlen         (axim_f_awlen),
        .m_awsize        (axim_f_awsize),
        .m_awburst       (axim_f_awburst),
        .m_awlock        (axim_f_awlock),
        .m_awcache       (axim_f_awcache),
        .m_awprot        (axim_f_awprot),
        .m_awvalid       (axim_f_awvalid),
        .m_awready       (axim_f_awready),
        .m_wdata         (axim_f_wdata),
        .m_wstrb         (axim_f_wstrb),
        .m_wlast         (axim_f_wlast),
        .m_wvalid        (axim_f_wvalid),
        .m_wready        (axim_f_wready),
        .m_bid           (axim_f_bid),
        .m_bresp         (axim_f_bresp),
        .m_bvalid        (axim_f_bvalid),
        .m_bready        (axim_f_bready),
        .m_arid          (axim_f_arid),
        .m_araddr        (axim_f_araddr),
        .m_arlen         (axim_f_arlen),
        .m_arsize        (axim_f_arsize),
        .m_arburst       (axim_f_arburst),
        .m_arlock        (axim_f_arlock),
        .m_arcache       (axim_f_arcache),
        .m_arprot        (axim_f_arprot),
        .m_arvalid       (axim_f_arvalid),
        .m_arready       (axim_f_arready),
        .m_rid           (axim_f_rid),
        .m_rdata         (axim_f_rdata),
        .m_rresp         (axim_f_rresp),
        .m_rlast         (axim_f_rlast),
        .m_rvalid        (axim_f_rvalid),
        .m_rready        (axim_f_rready),
