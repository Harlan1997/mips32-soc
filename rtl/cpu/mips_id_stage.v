...
module mips_id_stage (
    ...
    wire special2_reads_rt = (opcode == 6'b011100) &&
                             (func == 6'b000000 || func == 6'b000001 ||
                              ...
                              func == 6'b000101);
    // LWL/LWR merge the fetched word with the prior value of rt.  They are
    // loads in the ordinary decode path, but rt is still an architectural
    // source operand and must participate in load-use hazard detection.
    wire reads_rt = (opcode == 6'b000000) ? (func != 6'b001000 && func != 6'b001001 && func != 6'b010000 && func != 6'b010001 && func != 6'b010010 && func != 6'b010011) :
                    (special2_reads_rt || opcode == 6'b100010 || opcode == 6'b100110 || opcode == 6'b101011 || opcode == 6'b111001 || opcode == 6'b101001 || opcode == 6'b101000 || opcode == 6'b000100 || opcode == 6'b000101 ||
