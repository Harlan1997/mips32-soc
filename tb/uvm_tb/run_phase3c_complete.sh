...
rm -f -- "$REPORT" "${RUN_ROOT}/phase3c_error_scan.txt" \
    "${RUN_ROOT}/phase3c_error_scan.txt.tmp" "${RUN_ROOT}/phase3c_error_scan_err.txt"
mkdir -p "$RUN_ROOT"
...
scan_err="${RUN_ROOT}/phase3c_error_scan_err.txt"
