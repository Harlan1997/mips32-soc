...

{
    ...
    require_text "docs/asic_c1_ddr4_parameter_decision.md" "IN_PROGRESS / B_PHY_SELECTION_BLOCKED" "ASIC parameter decision stage"
    ...
    echo "| Stage A parameter decisions | IN_PROGRESS: owner sign-off pending |"
