...

{
    ...
    require_text "docs/asic_c1_ddr4_phy_selection_plan.md" "RFQ_PREPARATION / PHY_NOT_SELECTED" "PHY selection preparation"
    ...
    echo "| Stage B PHY/IP selection | RFQ preparation: PHY not selected |"
