...
RUN_DIR=${RUN_DIR:-"${ROOT_DIR}/build/unit_tb/fetch_pc_alignment"}
...
./simv -no_save \
    +FW_HEX="${SCRIPT_DIR}/data/fetch_pc_alignment.hex" \
    +SRAM_HEX="${SCRIPT_DIR}/data/fetch_pc_alignment.hex" -l sim.log
