...
vcs -full64 -sverilog -timescale=1ns/1ps \
    ...
    "${ROOT_DIR}"/tb/unit/bootrom/tb_product_tlb_vectors.sv -l compile.log

./simv -no_save \
    +FW_HEX="${SCRIPT_DIR}/data/product_tlb_vectors_sram.hex" \
    +SRAM_HEX="${SCRIPT_DIR}/data/product_tlb_vectors_sram.hex" \
    +BOOT_ROM_HEX="${SCRIPT_DIR}/data/product_tlb_vectors_boot.hex" -l sim.log
grep -q "REGRESSION_TEST_SUCCESS product_tlb_vectors" sim.log
