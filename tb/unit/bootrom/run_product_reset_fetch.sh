...
RUN_DIR=${RUN_DIR:-"${ROOT_DIR}/build/unit_tb/product_reset_fetch"}
...
vcs -full64 -sverilog -timescale=1ns/1ps \
    ...
    "${ROOT_DIR}"/tb/unit/bootrom/tb_product_reset_fetch.sv -l compile.log

./simv -no_save +FW_HEX="${ROOT_DIR}/tb/uvm_tb/data/flash_xip_image.hex" -l sim.log
grep -q "REGRESSION_TEST_SUCCESS product_reset_fetch" sim.log
