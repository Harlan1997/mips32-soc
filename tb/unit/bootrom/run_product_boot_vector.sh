...
RUN_DIR=${RUN_DIR:-"${ROOT_DIR}/build/unit_tb/product_boot_vector"}
...
vcs -full64 -sverilog -timescale=1ns/1ps \
    ...
    "${ROOT_DIR}"/tb/unit/bootrom/tb_product_boot_vector.sv -l compile.log

./simv -no_save \
    +FW_HEX="${ROOT_DIR}/tb/uvm_tb/data/flash_xip_image.hex" \
    +BOOT_ROM_HEX="${SCRIPT_DIR}/data/product_boot_vector.hex" -l sim.log
grep -q "REGRESSION_TEST_SUCCESS product_boot_vector" sim.log
