...
RUN_DIR=${RUN_DIR:-"${ROOT_DIR}/build/unit_tb/cpu_cache_error"}
...
vcs -full64 -sverilog -timescale=1ns/1ps \
    ...
    "${SCRIPT_DIR}/tb_mips_cpu_cacheerr.v" \
    -top tb_mips_cpu_cacheerr -l compile.log

./simv -no_save -l sim.log
grep -q "REGRESSION_TEST_SUCCESS mips_cpu_cacheerr" sim.log
