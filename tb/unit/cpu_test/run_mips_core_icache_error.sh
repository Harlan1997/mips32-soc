...
RUN_DIR=${RUN_DIR:-"${ROOT_DIR}/build/unit_tb/mips_core_icache_error"}
...
./simv -no_save +INJECT_ICACHE_ERROR -l sim.log
grep -q "REGRESSION_TEST_SUCCESS mips_core_icache_exec_error" sim.log
