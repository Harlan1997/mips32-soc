...
timeout "${HOST_TIMEOUT}" env \
    ...
    VCS_EXTRA_ARGS="+define+SOC_LINUX_BOOT_ENABLE=1 +define+SOC_PRODUCT_BOOT_ENABLE=1 +define+SOC_MMU_ENABLE=1 +define+TB_LINUX_BOOT +define+TB_LINUX_BOOT_TRACE${linux_retire_define}" \
    "${linux_retire_env[@]}" \
