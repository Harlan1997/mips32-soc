...
timeout "${HOST_TIMEOUT}" env \
    ...
    LINUX_EXTRA_SIM_ARGS="${LINUX_EXTRA_SIM_ARGS:-} +LINUX_PC_TRACE_CYCLE_START=${LINUX_PC_TRACE_CYCLE_START} +LINUX_PC_TRACE_CYCLE_END=${LINUX_PC_TRACE_CYCLE_END} +LINUX_STALL_TRACE=${LINUX_STALL_TRACE} +LINUX_STALL_TRACE_LIMIT=${LINUX_STALL_TRACE_LIMIT} +LINUX_STALL_TRACE_CYCLE_START=${LINUX_STALL_TRACE_CYCLE_START} +LINUX_STALL_TRACE_PC=${LINUX_STALL_TRACE_PC}" \
