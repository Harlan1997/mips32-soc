...
| `integration/function-contract` | 唯一功能集成线；当前 HEAD `fb3f2f5`，以 C2 `fcfc9c1` 为父线，已合入 C1 4-way I-cache、boot/memory 产品契约、Boot ROM/CP0 向量切片和 kseg0 runtime ABI gate；worktree clean | 当前验证和后续产品功能变更只在此线收敛，暂不直接推入 `master` |
