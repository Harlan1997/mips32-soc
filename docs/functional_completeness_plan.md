...
推荐基线已接受：28nm LP、BGA、1.2 V commercial、DDR4-2133、x32
single-rank、ECC disabled。`A-DDR4-02` foundry/PDK 和 `A-DDR4-09`
training/WDT 仍需外部签收；B 已进入 RFQ/候选筛选准备，不能宣称 PHY 已选。
...
| 2026-08-02 | `integration/function-contract` | 建立 [C1 DDR4 PHY/IP 筛选计划](asic_c1_ddr4_phy_selection_plan.md) | RFQ_PREPARATION：PHY_NOT_SELECTED | 已定义 Synopsys/Cadence/Rambus/foundry-approved 候选池、交付物和评分门槛；只有工艺/封装确认和 vendor 书面支持后，才能更新 `DDR4-IN-03/04/07`。 |
