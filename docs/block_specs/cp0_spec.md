...
- v0.8 (2026-08-05)：修正标准 RDHWR 的 `rs=0` 与 `rd=0/1/2/3/29` 指令编码、`$1/$3` CP0 selector/address 映射，并在 CPU 中串行化相邻 CP0 read；SoC gate 验证 `$0..$3/$29` kernel readback 及 user HWREna 权限矩阵。
